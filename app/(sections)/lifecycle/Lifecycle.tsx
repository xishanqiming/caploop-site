...
const cards = [
  {
    ...
    text: "按行业/区域/估值筛选，发现匹配的投资标的。",
  },
  {
    icon: FileSignature,
    title: "Review Profiles",
    text: "访问结构化资料与报告，理解潜力与风险画像。",
  },
  {
    icon: Users2,
    title: "Connect Directly",
    text: "建立直连，高效推进与管理投资流程。",
  },
];
...
export default function Lifecycle() {
  return (
    <Section
      id="lifecycle"
      center
      title="The Investor Journey"
      subtitle="Discover opportunities with transparent data"
    >
