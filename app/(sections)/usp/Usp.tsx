...
const rows = [
  {
    ...
    text: "分钟级估值与周级融资流程，成本仅为传统路径的一个量级。",
  },
  {
    icon: ShieldCheck,
    title: "Transparency & Trust",
    text: "可追溯方法学与对标数据，配合第三方审计/托管。",
  },
  {
    icon: Cpu,
    title: "Future-Ready",
    text: "估值-发行-流通 一体化路线，平滑过渡到合规 Tokenization。",
  },
  {
    icon: Scale,
    title: "Compliance by Design",
    text: "欧洲监管框架优先策略，最小化跨境合规摩擦。",
  },
];
...
export default function Usp() {
  return (
    <Section
      id="usp"
      center
      title="Why Caploop Stands Out"
      subtitle="The edge that differentiates us from traditional platforms"
    >
